...
if __name__ == "__main__":
    ...
    for i, j in enumerate(content):
        ...
        total_token_used = LLM_only(main_prompt, f"give me cot and action sequence to prepare {list(content.keys())[i]}. The minimum ingredients for this dish are {content[j]}. Please use these ingredients only." , args.arg1, i+5, tokens, list(content.keys())[i], content[j])
        ...
        total_token_used = LLM_KG(main_prompt, f"give me cot and action sequence to prepare {list(content.keys())[i]}. The minimum ingredients for this dish are {content[j]}. Please use these ingredients only." , args.arg1, i+5, tokens, list(content.keys())[i], content[j])
        ...
        total_token_used = LLM_KG_Human(main_prompt, f"give me cot and action sequence to prepare {list(content.keys())[i]}. The minimum ingredients for this dish are {content[j]}. Please use these ingredients only.", args.arg1, i+5, tokens, list(content.keys())[i], content[j])

...
if __name__ == "__main__":
    ...
    if args.arg2 == 0: #no_feedback
        ...
        if need_feedback and i==int(args.arg2): #human involvement
            ...
            if RBO!='':
                print("\n\n")
                Human_involvement, additions_made, corrections_made = knowledge_expansion(f"./feedback/LLM_updated_output_{len(os.listdir('feedback'))//3}.txt")
                function_correction(f"./feedback/LLM_updated_output_{len(os.listdir('feedback'))//3}.txt")

...
def LLM_KG(main_prompt, my_prompt, n_fb, iter, maintok, dish_name, dish_ingd):
    ...
    if n_fb == 0: #no_feedback
        ...
        if co:
            ...
            run_py('./LLM_KG/final_run.py', "./LLM_KG/output.txt", "./LLM_KG/output_with_error.txt" )
        ...
        if co and RBO == '': #proceed and execute; wait for results
            ...
            if not os.path.exists("./LLM_KG/output_with_error.txt"):
    ...
    shutil.copy("./LLM_KG/output.txt", f"./LLM_KG/experiment_results/results_{iter}/Execution_outputs_{iter}")

    if os.path.exists("./LLM_KG/output_with_error.txt"):
        shutil.copy("./LLM_KG/output_with_error.txt", f"./LLM_KG/experiment_results/results_{iter}/Execution_outputs_{iter}")

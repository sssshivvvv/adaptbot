...
if __name__ == "__main__":
    ...
    for i, j in enumerate(content):
        ...
        total_token_used = LLM_only(main_prompt, f"give me cot and action sequence to {list(content.keys())[i]}. The minimum items invlolved in this task should be {content[j]}. Choose the items wisely, dont use irrelevant things.", args.arg1, i+33, tokens, list(content.keys())[i], content[j])
        ...
        total_token_used = LLM_KG(main_prompt, f"give me cot and action sequence to {list(content.keys())[i]}. The minimum items invlolved in this task should be {content[j]}. Choose the items wisely, dont use irrelevant things.", args.arg1, i+33, tokens, list(content.keys())[i], content[j])
        ...
        total_token_used = LLM_KG_Human(main_prompt,f"give me cot and action sequence to {list(content.keys())[i]}. The minimum items invlolved in this task should be {content[j]}. Choose the items wisely, dont use irrelevant things.", args.arg1, i+33, tokens, list(content.keys())[i], content[j])
